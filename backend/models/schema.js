/**
 * Neon PostgreSQL Schema Definition & Seed Migration
 * 
...
async function initDatabase() {
  if (!db.isConfigured()) {
    console.log('ℹ️ DATABASE_URL not present. Skipping PostgreSQL schema initialization.');
    return;
  }

  try {
    console.log('🔄 Checking & initializing Neon PostgreSQL schema...');
    ...
    if (parseInt(membersCheck.rows[0].count, 10) === 0) {
      ...
      console.log('🌱 Seeded 5 initial welfare members.');
    }
    ...
    if (parseInt(usersCheck.rows[0].count, 10) === 0) {
      ...
      console.log('🌱 Seeded 3 default users (Admin & Members).');
    }
    ...
    if (parseInt(loansCheck.rows[0].count, 10) === 0) {
      ...
      console.log('🌱 Seeded 3 initial welfare loans.');
    }
    ...
    if (parseInt(contCheck.rows[0].count, 10) === 0) {
      ...
      console.log('🌱 Seeded 5 initial contribution receipts.');
    }
    ...
    if (parseInt(txCheck.rows[0].count, 10) === 0) {
      ...
      console.log('🌱 Seeded 8 initial finance transactions.');
    }
